  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#080808] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="aurora-blob-1 absolute -top-32 -left-32 w-[380px] h-[380px] rounded-full opacity-15"
          style={{ background: "radial-gradient(ellipse, #f97316 0%, transparent 70%)" }} />
        <div className="aurora-blob-3 absolute -bottom-24 -right-24 w-[300px] h-[300px] rounded-full opacity-10"
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-6 max-w-sm w-full mx-auto">
        <div className="mb-10 fade-in-scale">
          <h1 className="font-serif font-black text-white text-3xl mb-2">Create account</h1>
          <p className="text-white/45 text-sm">Start organising your life beautifully.</p>
        </div>

        <div className="space-y-5 slide-up">
          <div className="space-y-1.5">
            <Label htmlFor="name" className="text-white/60 text-xs uppercase tracking-wider font-semibold">Name</Label>
          ...
          <Button className="w-full h-13 text-base rounded-xl font-bold mt-2 shadow-lg shadow-primary/25 hover:-translate-y-0.5 active:translate-y-0 transition-all"
            onClick={handleRegister} data-testid="register-submit">
            Create Account
          </Button>
        </div>
